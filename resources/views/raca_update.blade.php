                  ...
                  <!-- <div class="card-header pb-0 p-3">
                    ...
                    <div class="card-body p-3">
                        <div class="table-responsive">
                            @foreach ($raca as $r)
                            <form action="{{ route('raca_update', $r->raca_id )}}" method="POST">
                                @method('PUT')
                                @csrf

                                <div class="form-group">
                                    <label> Raca Nome  </label>
                                    <input type="text" class="form-control" id="nome_tipo" style="width: 250px"  name="tipo_animal" value="{{$r->raca_nome}}">
                                </div>
