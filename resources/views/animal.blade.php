            ...
            <div class="col-xl-12 col-sm-6 mb-xl-0 mb-4" style="height: 1050px !important">      
                <div class="card">
                  <!-- <div class="card-header pb-0 p-3">
                    ...
                    <a href="{{route('createForm')}}"> Adicionar </a>
                                ...
                                <tr>
                                  <td class="">
                                    <div class="d-flex  align-items-center" style="width: 10% !important;">
                                      ...
                                      <div class="ms-4">
                                        <h6 class="text-sm mb-0">  {{$animal->animal_id}} </h6>
                                      </div>
                                    </div>
                                  </td>
                                  <td>
                                    <div class="text-center">
                                      <h6 class="text-sm mb-0">{{$animal->tipo_animal}}   </h6>
                                    </div>
                                  </td>
                                  <td>
                                    <div class="text-center">
                                      <h6 class="text-sm mb-0">{{$animal->animal_raca}}   </h6>
                                    </div>
                                  </td>
                                  <td>
                                    <div class="text-center">
                                      <h6 class="text-sm mb-0">{{$animal->dispositivo_serie}}  </h6>
                                    </div>
                                  </td>

                                  <td class="align-middle text-sm">
                                    <div class="col text-center">
                                      <h6 class="text-sm mb-0"> {{$animal->created_at}}    </h6>
                                    </div>
                                  </td>
                                  <td>
                                    <div>
                                     <a href="/animal_update/{{$animal->animal_id}}" > <img src="{{ asset('./assets/img/icons/flags/editing.png') }}" alt="Country flag" width="20" height="20" > </a>
