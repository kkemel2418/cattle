                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control d-flex" style="width: 250px" name='id_tipo'>
                                        @foreach ($tipo as $t)
                                        <option  value="{{$t->tipo_animal_id}}"  >{{$t->tipo_animal}}</option>
                                        @endforeach
                                      </select>
                                </div>
                             ...
                             <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 15%" name='animal_raca' >
                                        @foreach ($raca as $r)
                                        <option  value="{{$r->raca_id}}"  >{{$r->raca_nome}}t</option>
                                        @endforeach
                                      </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 15%" name='vacina'>
                                        @foreach ($vacina as $v)
                                        <option  value="{{$v->vacina_id}}"  >{{$v->nome_vacina}}t</option>
                                        @endforeach
                                      </select>
                            </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  style="width: 250px" name="evento_id">
                                        @foreach ($evento as $e)
                                        <option  value="{{$e->evento_id}}"  >{{$e->evento_nome}}t</option>
                                        @endforeach
                                      </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  style="width: 250px" name='dispositivo_id' >
                                        ...
                                        <option  value="{{$d->id}}"  > {{$d->dispositivo_serie}}</option>
                                        @endforeach
                                      </select>
                                </div>
                                <div class="form-group">
